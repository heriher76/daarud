...
<head>
  ...
  <title>Daarud Dakwah | Admin Panel</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      <!-- <img src="#" style="width: 80%; height: auto;" alt="logo MAI"> -->
      Daarud Dakwah
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="{{ url('/') }}">Daarud Dakwah</a>.</strong> All rights reserved.
  </footer>
